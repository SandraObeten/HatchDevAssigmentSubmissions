...
//Update Laptop
const newDisplay = new Display();import { Laptop, KeyBoard, KeyBoardKind, KeyBoardLayout,BitKind, Display, DisplayType, NetworkInterfaceCard, HardDisk, HardDiskType, OperatingSystem} from "./ModelLaptopWithComposition.ts";
